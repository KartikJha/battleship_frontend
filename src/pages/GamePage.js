...
const GamePage = () => {
  ...
  const [shotPosition, setShotPosition] = useState('A1')
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-blue-100 p-6">
      <div className="max-w-4xl mx-auto">
        <header className="mb-6 text-center">
          ...
          <p className="text-gray-600 text-sm mt-2">Grid Position: {gridId}</p>
        </header>
        ...
        <div className="grid grid-cols-2 gap-6">
          <div className="md:col-span-2 bg-white rounded-xl shadow-lg p-6">
            ...
            <p className="mt-4">
              Missile Count: {gameData.boards[playerId].missile_count}
            </p>
          </div>
          ...
          <div className="md:col-span-2 bg-white rounded-xl shadow-lg p-6">
            ...
            <p className="mt-4">
              Missile Count: {gameData.boards[enemyId].missile_count}
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 flex flex-col">
          ...
          <Button
            onClick={sendShot}
            disabled={
              gameStatus !== 'connected' || gameData.current_turn !== playerId
            }
